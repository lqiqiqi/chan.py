...
class TigerReal(CCommonStockApi):
    is_connect = None

    def __init__(self, code, k_type=KL_TYPE.K_DAY, begin_date=None, end_date=None, autype=AUTYPE.QFQ):
        super(TigerReal, self).__init__(code, k_type, begin_date, end_date, autype)
        self.columns = [
    ...
    def do_init(cls):
        ...
        file_path = f"{cur_path}/RealAccountConfig"

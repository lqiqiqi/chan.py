...
def train_buy_model(code, begin_time, end_time):
    ...
    clf3 = make_pipeline(
         ...
         xgb.XGBClassifier(max_depth=30, n_estimators=30, learning_rate=0.15, objective='binary:logistic',
    ...
    for clf, label in zip([sclf], ['StackingClassifier']):
        ...
        precision_scores = model_selection.cross_val_score(clf, X, y, cv=4, scoring='precision')

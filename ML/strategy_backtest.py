...
def plot(chan, plot_marker):
    ...
    plot_driver.save2img("backtest_buy_sell_prob.png")
...
if __name__ == "__main__":
    ...
    for chan_snapshot in chan.step_load():
        ...
        if is_hold:
            ...
            pred_prob = predict_bsp(sell_model, last_bsp, sell_meta)[0]
            ...
            if pred_prob > 0.8:
                # or last_klu.close < last_buy_price * 0.98
        ...
        if not is_hold:
            ...
            pred_prob = predict_bsp(buy_model, last_bsp, buy_meta)[0]
            ...
            if pred_prob > 0.8:
                buy_idx_list.append(last_klu.idx)
            if (len(buy_idx_list) > 2 and last_klu.idx - buy_idx_list[-3] < 7) and \
                    cur_lv_chan[-1][-1].close != sell_price:
                plot_marker[last_klu.time.to_str()] = (
                    pred_prob, "down", 'red')

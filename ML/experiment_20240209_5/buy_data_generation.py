...
def train_buy_model(code, begin_time, end_time):
    ...
    # with open("bsp_dict_bsp3_20240209_5.pkl", "rb") as f:
    ...
    save_obj(bsp_dict, 'bsp_dict_bsp3_20240209_5')
    ...
    cur_feature_idx = 0
    plot_marker = {}
    fid = open(f"buy_feature_{code}_bsp3_20240209_5.libsvm", "w")
    ...
    with open(f"buy_feature_{code}_bsp3_20240209_5.meta", "w") as fid:
        # meta保存下来，实盘预测时特征对齐用
    ...
    bst.save_model(f"buy_model_{code}_bsp3_20240209_5.json")
    ...
    # 全量训练
    dtotal = xgb.DMatrix(f"buy_feature_{code}_bsp3_20240209_5.libsvm?format=libsvm")  # load sample
    ...
    bst_total.save_model(f"buy_model_{code}_bsp3_20240209_5.json")

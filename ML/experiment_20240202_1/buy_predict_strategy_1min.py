    ...
    for code in ['MNQmain']:
        ...
        for threshold in [0.6]:
            for retrace_rate in [0.2]:
                # [15 * 60]
                for wait_time_min in [5, 15, 20, 25, 30, 1000000]:
                    wait_time_seconds = wait_time_min * 60
                    # begin_time = "2023-11-01 00:01:00", end_time = "2024-01-01 00:00:00",
                    ...
                    exp_return, odds, win_rate, average_daily_trades, mean_profit, total_profit = buy_model_predict(
                        code=code, begin_time = "2023-11-01 00:01:00", end_time = "2024-01-01 00:00:00",

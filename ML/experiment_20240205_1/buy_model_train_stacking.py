...
def train_buy_model(code, begin_time, end_time):
    ...
    clf3 = make_pipeline(
        ...
        xgb.XGBClassifier(max_depth=30, n_estimators=40, learning_rate=0.1, objective='binary:logistic',
                             scale_pos_weight=4.2, reg_lambda=20, subsample=0.9, random_state=1, missing=np.nan)
    )
    clf4 = make_pipeline(
    ...
    # dump(sclf, f'buy_model_{code}_20240205_1.joblib')
    clf_loaded = load(f'buy_model_{code}_20240205_1.joblib')

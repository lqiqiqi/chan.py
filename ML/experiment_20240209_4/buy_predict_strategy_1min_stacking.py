...
from ML.experiment_20240209_4.buy_data_generation import buy_stragety_feature
...
def buy_model_predict(code, begin_time, dependent_time, threshold, retrace_rate, wait_time_seconds, end_time=None):
    ...
    model = load(f'buy_model_{code}_bsp4_20240209_4.joblib')
    meta = json.load(open(f"buy_feature_{code}_bsp4_20240209_4.meta", "r"))

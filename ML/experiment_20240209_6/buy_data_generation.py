...
def train_buy_model(code, begin_time, end_time):
    ...
    # with open("bsp_dict_bsp5_20240209_6.pkl", "rb") as f:
    ...
    for last_klu in data_src_5m.get_kl_data():
        ...
        if last_bsp.klu.idx not in bsp_dict and cur_lv_chan[-5].idx == last_bsp.klu.klc.idx and last_bsp.is_buy:
    ...
    save_obj(bsp_dict, 'bsp_dict_bsp5_20240209_6')
    ...
    cur_feature_idx = 0
    plot_marker = {}
    fid = open(f"buy_feature_{code}_bsp5_20240209_6.libsvm", "w")
    ...
    for bsp_klu_idx, feature_info in bsp_dict.items():
        ...
        for klc in bi_tmp.klc_lst:
            if klc.pre.pre.pre.pre == tmp_klc:
    ...
    with open(f"buy_feature_{code}_bsp5_20240209_6.meta", "w") as fid:
        # meta保存下来，实盘预测时特征对齐用
    ...
    bst.save_model(f"buy_model_{code}_bsp5_20240209_6.json")
    ...
    # 全量训练
    dtotal = xgb.DMatrix(f"buy_feature_{code}_bsp5_20240209_6.libsvm?format=libsvm")  # load sample
    ...
    bst_total.save_model(f"buy_model_{code}_bsp5_20240209_6.json")
